...
implementation path the tests compile). At integration time these
copies are discarded — production files win. Re-diff before collecting:
the firmware tree was being edited while this pack was written.
