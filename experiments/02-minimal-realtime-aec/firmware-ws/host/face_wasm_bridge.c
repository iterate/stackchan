...
{
    return face_avatar_catalog_info_at(profile, info) ? 1 : 0;
}
...
{
    return face_avatar_registry_render_snapshot_at(
               profile,
               render_key,
               sample_clock,
               rgb565,
