...
static const face_robot_expression_target_t
    EXPRESSION_TARGETS[FACE_EXPRESSION_COUNT] = {
        ...
        [FACE_EXPRESSION_CONCERN] = {
            {242, 222}, {48, 32}, {138, 112}, {0, 0}, {0, 0}, {0, 0},
            {0, 0}, {-22, 8}, {250, 266}, -700, 4, 20,
        },
        ...
        [FACE_EXPRESSION_THOUGHTFUL] = {
            {226, 166}, {52, -8}, {92, -42}, {0, 0}, {0, 0}, {0, 0},
            {0, 0}, {-82, -58}, {252, 252}, -4200, -4, 6,
        },
        [FACE_EXPRESSION_SKEPTICAL] = {
            {224, 106}, {28, -52}, {74, -154}, {0, 0}, {0, 0}, {0, 0},
            {0, 0}, {42, -4}, {266, 244}, -2400, -6, 16,
        },
        [FACE_EXPRESSION_DETERMINED] = {
            {166, 166}, {-72, -72}, {-174, -174}, {0, 0}, {0, 0}, {0, 0},
            {0, 0}, {0, -14}, {276, 232}, 0, -12, 72,
        },
        [FACE_EXPRESSION_SLEEPY] = {
            {72, 58}, {-34, -42}, {18, 8}, {0, 0}, {0, 0}, {0, 0},
            {160, 160}, {18, 72}, {248, 226}, 2600, -48, -82,
        },
        ...
        [FACE_EXPRESSION_EMBARRASSED] = {
            {142, 184}, {62, 30}, {124, 62}, {0, 0}, {0, 0}, {0, 0},
            {-520, -360}, {104, 46}, {256, 244}, 3900, 12, 34,
        },
    };
